...
course_tbl <- tribble(
  ...
  "3 - Static Visuals", "EDA Visualization, Static graphics with R/Python", "Understand your data with ggplot", "*", "",
  "3 - Static Visuals", "More Static graphics with R/Python", "Make graphs with R", "*", "A4 due Fri 10/9",
  "4 - Specialized Visuals", "Maps and geospatial data", "Activity 8", "*", "",
  "4 - Specialized Visuals", "Networks", "Activity 9", "*", "A5 due Fri 10/23",
  "4 - Specialized Visuals", "Text data", "Activity 10", "*", "A6 due Fri 10/31",
  "5 - Dynamic Visuals", "Dynamic graphs 1", "Activity 11", "*", "A7 due Fri 11/6",
  "5 - Dynamic Visuals", "Dynamic graphs 2", "Activity 12", "*", "A8 due Fri 11/13",
  "6 - ML", "Visualizing model dianostics and results", "ML diagnostics", "*", "A9 due Fri 11/20",
